...
if ( $multi_button_lists ) :
    ...
    $link_open = get_theme_mod(
        'zenvy_footer_multi_buttons_link_open',
        ''
    );
    ...
    $col_per_row = get_theme_mod(
        'zenvy_footer_multi_buttons_items_per_row',
        [
            'desktop'           => '1',
            'tablet'            => '1',
            'mobile'            => '1'
    ...
    ?>
    <ul class="footer-buttons-wrap row columns d-flex align-items-center justify-content-between"<?php Zenvy_Helper::get_data_columns( $col_per_row );?>>
