...
$enable_banner_slider = get_theme_mod( 'zenvy_front_page_banner_slider_enable', ['desktop' => 'true'] );
            ...
            <div class="banner-slider">
                <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                    <div class="slider-item">
                        ...
                        <?php else : ?>
                            <?php zenvy_post_thumbnail( 'full', '16x9' ); ?>
                        <?php endif; ?>
                                    ...
                                    <div class="property-meta entry-meta">
                                        ...
                                        <?php if ( $bedrooms = get_post_meta( get_the_ID(), 'cre_property_bedrooms', true ) ) : ?>
                                            ...
                                            <span class="meta-icon">
                                                ...
                                                <span class="meta-unit"><?php esc_html_e( 'bedroom', 'zenvy' ); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if ( $bathrooms = get_post_meta( get_the_ID(), 'cre_property_bathrooms', true ) ) : ?>
                                            ...
                                            <span class="meta-icon">
                                                ...
                                                <span class="meta-unit"><?php esc_html_e( 'bathroom', 'zenvy' ); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if ( $garage = get_post_meta( get_the_ID(), 'cre_property_garage', true ) ) : ?>
                                            ...
                                            <span class="meta-icon">
                                                ...
                                                <span class="meta-unit"><?php esc_html_e( 'garage', 'zenvy' ); ?></span>
                                            </div>
                                        <?php endif; ?>
