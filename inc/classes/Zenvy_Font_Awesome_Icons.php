...
class Zenvy_Font_Awesome_Icons {
	...
	public static function get_icon( $group, $icon ) {
		 ...
		 */
		$arr = apply_filters( "zenvy_font_awesome_icons_{$group}", $arr );
		...
		echo apply_filters( 'zenvy_get_font_awesome_icon', $output ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
}
