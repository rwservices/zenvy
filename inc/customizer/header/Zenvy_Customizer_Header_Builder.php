...
class Zenvy_Customizer_Header_Builder {
     ...
     *
     */
    public $builder_section_controller = 'zenvy_header_builder_controller_section';
     ...
     *
     */
    public $header_top = 'zenvy_header_top';
     ...
     *
     */
    public $header_main = 'zenvy_header_main';
     ...
     * Main Instance
     *
     * Insures that only one instance of Zenvy_Customizer_Header_Builder exists in memory at any one
    ...
    public function run() {
        ...
        add_filter( 'zenvy_default_theme_options', array( $this, 'header_defaults' ) );
        add_filter( 'zenvy_builders', array( $this, 'header_builder' ) );

        add_action( 'zenvy_header', array( $this, 'zenvy_header_display' ), 100 );
    }
    ...
    public function header_builder( $builder ) {
        ...
        $items = apply_filters(
            ...
            array(
                Zenvy_Customizer_Header_Builder()->site_identity   => array(
                    'name'    => esc_html__( 'Site Identity', 'zenvy' ),
                    'id'      => Zenvy_Customizer_Header_Builder()->site_identity,
                    'section' => Zenvy_Customizer_Header_Builder()->site_identity,
                ),
                Zenvy_Customizer_Header_Builder()->primary_menu => array(
                    'name'    => esc_html__( 'Primary Menu', 'zenvy' ),
                    'id'      => Zenvy_Customizer_Header_Builder()->primary_menu,
                    'section' => Zenvy_Customizer_Header_Builder()->primary_menu,
                ),
                Zenvy_Customizer_Header_Builder()->social_icons    => array(
                    'name'    => esc_html__( 'Social Icons', 'zenvy' ),
                    'id'      => Zenvy_Customizer_Header_Builder()->social_icons,
                    'section' => Zenvy_Customizer_Header_Builder()->social_icons,
                ),
                Zenvy_Customizer_Header_Builder()->search_icon  => array(
                    'name'    => esc_html__( 'Search Icon', 'zenvy' ),
                    'id'      => Zenvy_Customizer_Header_Builder()->search_icon,
                    'section' => Zenvy_Customizer_Header_Builder()->search_icon,
                ),
                Zenvy_Customizer_Header_Builder()->button_one   => array(
                    'name'    => esc_html__( 'Button', 'zenvy' ),
                    'id'      => Zenvy_Customizer_Header_Builder()->button_one,
                    'section' => Zenvy_Customizer_Header_Builder()->button_one,
                ),
                Zenvy_Customizer_Header_Builder()->account  => array(
                    'name'    => esc_html__( 'Account', 'zenvy' ),
                    'id'      => Zenvy_Customizer_Header_Builder()->account,
                    'section' => Zenvy_Customizer_Header_Builder()->account,
                ),
                Zenvy_Customizer_Header_Builder()->toggle_menu  => array(
                    'name'    => esc_html__( 'Mobile Menu', 'zenvy' ),
                    'id'      => Zenvy_Customizer_Header_Builder()->toggle_menu,
                    'section' => Zenvy_Customizer_Header_Builder()->toggle_menu,
                ),
                Zenvy_Customizer_Header_Builder()->html  => array(
        ...
        $header_builder = array(
            Zenvy_Customizer_Header_Builder()->panel => array(
                'id'         => Zenvy_Customizer_Header_Builder()->panel,
                'title'      => esc_html__( 'Header Builder', 'zenvy' ),
                'control_id' => Zenvy_Customizer_Header_Builder()->builder_section_controller,
    ...
    public function customize_register( $wp_customize ) {
        ...
        $wp_customize->add_section(
            $this->header_top,
            array(
                'title'    => esc_html__( 'Top Row', 'zenvy' ),
                'priority' => 20,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            $this->header_main,
            array(
                'title'    => esc_html__( 'Main Row', 'zenvy' ),
                'priority' => 25,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            $this->header_bottom,
            array(
                'title'    => esc_html__( 'Bottom Row', 'zenvy' ),
                'priority' => 25,
                'panel'    => $this->panel,
            )
        );
        ...
        $wp_customize->add_section(
            $this->primary_menu,
            array(
                'title'    => esc_html__( 'Primary Menu', 'zenvy' ),
                'priority' => 40,
                'panel'    => $this->panel,
            )
        );
        ...
        $wp_customize->add_section(
            $this->social_icons,
            array(
                'title'    => esc_html__( 'Social Icons', 'zenvy' ),
                'priority' => 55,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            $this->account,
            array(
                'title'    => esc_html__( 'Account', 'zenvy' ),
                'priority' => 65,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            $this->search_icon,
            array(
                'title'    => esc_html__( 'Search Icon', 'zenvy' ),
                'priority' => 70,
                'panel'    => $this->panel,
            )
        );
        ...
        $wp_customize->add_setting(
            ...
            array(
                ...
                'sanitize_callback' => 'zenvy_sanitize_field',
        ...
        $wp_customize->add_control(
            $this->builder_section_controller,
            array(
                'label'    => esc_html__( 'Header Builder', 'zenvy' ),
        ...
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Top_Row_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Main_Row_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Bottom_Row_Fields.php';

        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Site_Identity_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Primary_Menu_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Button_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Social_Icons_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Account_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Search_Icon_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Toggle_Menu_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Html_Fields.php';
		require ZENVY_DIR  . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Color_Mode_Fields.php';
    }
    ...
    public function column_elements( $column_elements) {
		foreach ( $column_elements as $element ) {
			...
			zenvy_get_template_part( $id, $slug );
		}
    }
							...
							<div class="container">
								<div class="<?php echo esc_attr( implode( ' ', $top_row_class) );?>">
									<?php if ( array_key_exists( 'col-0', $top_elements ) || array_key_exists('col-2', $top_elements ) ) :
										...
										$top_lef_col_class[] 	= zenvy_get_classes($top_row_left_col,'justify-content-');
										$top_lef_col_class[]	= 'site-header-section site-header-section-left';
										if ( array_key_exists('col-0', $top_elements ) && zenvy_find_array_key_value($top_elements['col-0'],'id','search_icon') ) {
											$top_lef_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-0', $top_elements ) && zenvy_find_array_key_value($top_elements['col-0'],'id','toggle_menu') ) {
									...
									<?php if ( array_key_exists( 'col-1', $top_elements ) ) :
										...
										$top_center_col_class[] = zenvy_get_classes($top_row_center_col,'justify-content-');
										$top_center_col_class[]	= 'site-header-section site-header-section-center';
										if ( array_key_exists('col-1', $top_elements ) && zenvy_find_array_key_value($top_elements['col-1'],'id','search_icon') ) {
											$top_center_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-1', $top_elements ) && zenvy_find_array_key_value($top_elements['col-1'],'id','toggle_menu') ) {
									...
									<?php if ( array_key_exists( 'col-0', $top_elements ) || array_key_exists('col-2', $top_elements ) ) :
										...
										$top_right_col_class[] 	= zenvy_get_classes($top_row_right_col,'justify-content-');
										$top_right_col_class[]	= 'site-header-section site-header-section-right';
										if ( array_key_exists('col-2', $top_elements ) && zenvy_find_array_key_value($top_elements['col-2'],'id','search_icon') ) {
											$top_right_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-2', $top_elements ) && zenvy_find_array_key_value($top_elements['col-2'],'id','toggle_menu') ) {
							...
							<div class="container">
								<div class="<?php echo esc_attr( implode( ' ', $main_row_class) );?>">
									<?php if ( array_key_exists( 'col-0', $main_elements ) || array_key_exists('col-2', $main_elements ) ) :
										...
										$main_lef_col_class[] 	= zenvy_get_classes($main_row_left_col,'justify-content-');
										$main_lef_col_class[]	= 'site-header-section site-header-section-left';
										if ( array_key_exists('col-0', $main_elements ) && zenvy_find_array_key_value($main_elements['col-0'],'id','search_icon') ) {
											$main_lef_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-0', $main_elements ) && zenvy_find_array_key_value($main_elements['col-0'],'id','toggle_menu') ) {
									...
									<?php if ( array_key_exists( 'col-1', $main_elements ) ) :
										...
										$main_center_col_class[] 	= zenvy_get_classes($main_row_center_col,'justify-content-');
										$main_center_col_class[]	= 'site-header-section site-header-section-center';
										if ( array_key_exists('col-1', $main_elements ) && zenvy_find_array_key_value($main_elements['col-1'],'id','search_icon') ) {
											$main_center_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-1', $main_elements ) && zenvy_find_array_key_value($main_elements['col-1'],'id','toggle_menu') ) {
									...
									<?php if ( array_key_exists( 'col-0', $main_elements ) || array_key_exists('col-2', $main_elements ) ) :
										...
										$main_right_col_class[] = zenvy_get_classes($main_row_right_col,'justify-content-');
										$main_right_col_class[]	= 'site-header-section site-header-section-right';
										if ( array_key_exists('col-2', $main_elements ) && zenvy_find_array_key_value($main_elements['col-2'],'id','search_icon') ) {
											$main_right_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-2', $main_elements ) && zenvy_find_array_key_value($main_elements['col-2'],'id','toggle_menu') ) {
							...
							<div class="container">
								<div class="<?php echo esc_attr( implode( ' ', $bottom_row_class) );?>">
									<?php if ( array_key_exists( 'col-0', $bottom_elements ) || array_key_exists('col-2', $bottom_elements ) ) :
										...
										$bottom_lef_col_class[]   = zenvy_get_classes($bottom_row_left_col,'justify-content-');
										$bottom_lef_col_class[]   = 'site-header-section site-header-section-left';
										if ( array_key_exists('col-0', $bottom_elements ) && zenvy_find_array_key_value($bottom_elements['col-0'],'id','search_icon') ) {
											$bottom_lef_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-0', $bottom_elements ) && zenvy_find_array_key_value($bottom_elements['col-0'],'id','toggle_menu') ) {
									...
									<?php if ( array_key_exists( 'col-1', $bottom_elements ) ) :
										...
										$bottom_center_col_class[]    = zenvy_get_classes($bottom_row_center_col,'justify-content-');
										$bottom_center_col_class[]    = 'site-header-section site-header-section-center';
										if ( array_key_exists('col-1', $bottom_elements ) && zenvy_find_array_key_value($bottom_elements['col-1'],'id','search_icon') ) {
											$bottom_center_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-1', $bottom_elements ) && zenvy_find_array_key_value($bottom_elements['col-1'],'id','toggle_menu') ) {
									...
									<?php if ( array_key_exists( 'col-0', $bottom_elements ) || array_key_exists('col-2', $bottom_elements ) ) :
										...
										$bottom_right_col_class[] = zenvy_get_classes($bottom_row_right_col,'justify-content-');
										$bottom_right_col_class[] = 'site-header-section site-header-section-right';
										if ( array_key_exists('col-2', $bottom_elements ) && zenvy_find_array_key_value($bottom_elements['col-2'],'id','search_icon') ) {
											$bottom_right_col_class[]	= 'col-has-search-element';
										}
                                        if ( array_key_exists('col-2', $bottom_elements ) && zenvy_find_array_key_value($bottom_elements['col-2'],'id','toggle_menu') ) {
...
if ( ! function_exists( 'zenvy_get_header_builder_options' ) ) :
    function zenvy_get_header_builder_options( $key = '' ) {
        if ( ! empty( $key ) ) {
            ...
            return apply_filters( 'zenvy_' . $key, $theme_mod_values );
        }
        return false;
    }
endif;
...
if ( ! function_exists( 'zenvy_find_array_key_value' ) ) :
	function zenvy_find_array_key_value( $array, $key, $val ) {
		foreach ($array as $item) {
			if (is_array($item) && zenvy_find_array_key_value($item, $key, $val)) return true;
