...
class Zenvy_Customizer_Footer_Builder {
    ...
    public function customize_register( $wp_customize ) {
        ...
        $wp_customize->add_section(
            'zenvy_footer_builder_widget_section',
            array(
                'title'    => esc_html__( 'Widget Settings', 'zenvy' ),
                'priority' => 65,
                'panel'    => $this->panel,
            )
        );
        ...
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Top_Row_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Main_Row_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Bottom_Row_Fields.php';

        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Copyright_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Social_Icons_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Button_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Menu_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Html_Fields.php';

        // Back to top
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Widget_Fields.php';
        require ZENVY_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Back_To_Top_Fields.php';
    }
