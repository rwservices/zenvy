 ...
 *
 */
abstract class Zenvy_Customize_Base_Field {
    ...
    public function __construct() {
        ...
        add_action( 'customize_register', [ $this, 'zenvy_customizer_add_fields' ], 10, 1 );
    }
     ...
     * @return void
     */
    public function zenvy_customizer_add_fields( $wp_customize ) {
