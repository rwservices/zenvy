<?php
/**
 * Zenvy Theme Customizer Single Page Sidebar settings
 *
 * @package Zenvy
 */
	...
	public function init() {
		$this->args = [
			...
			'zenvy_single_page_sidebar_layout' => [
				...
				'description'       => esc_html__( 'Select sidebar layout for single page.', 'zenvy' ),
...
new Zenvy_Customize_Single_Page_Sidebar_Fields();
