...
/**
 * Zenvy_Customize_Background_Control class
 */
class Zenvy_Customize_Background_Control extends Zenvy_Customize_Base_Control {
        ...
        <div class="controls-wrap">
            ...
            <div class="control-wrap d-flex justify-content-between position-relative background">
                ...
                <label id="{{ data.id }}-color" class="buttonset-label d-flex flex-column justify-content-center align-items-center position-relative buttonset-label-on" for="{{ data.id }}-color">
                    <span><?php esc_html_e( 'Color', 'zenvy' ); ?></span>
                </label>
                <# } #>
                ...
                <label id="{{ data.id }}-gradient" class="buttonset-label d-flex flex-column justify-content-center align-items-center position-relative" for="{{ data.id }}-gradient">
                    <span><?php esc_html_e( 'Gradient', 'zenvy' ); ?></span>
                </label>
                <# } #>
                ...
                <label id="{{ data.id }}-image" class="buttonset-label d-flex flex-column justify-content-center align-items-center position-relative" for="{{ data.id }}-image">
                    <span><?php esc_html_e( 'Image', 'zenvy' ); ?></span>
                </label>
                <# } #>
            ...
            <# if ( fields.image ) { #>
            <div class="d-flex justify-content-between align-items-center">
                <span class="customize-control-title"><?php esc_html_e( 'Image', 'zenvy' ); ?></span>
            </div>
            ...
            <div class="control-wrap d-flex justify-content-between position-relative background-image">
                <div class="background-image w-100">
                    <div class="attachment-media-view w-100">
                        <button type="button" class="upload-button button-add-media"><?php esc_html_e( 'Select Image', 'zenvy' ); ?></button>
                    </div>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center background-position">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Position', 'zenvy' ); ?></span>
                ...
                <select class="select background-position-select w-60" data-reset="{{ position_reset }}">
                    ...
                    <option value="top left"><?php esc_html_e( 'Top Left', 'zenvy' ); ?></option>
                    <option value="top center"><?php esc_html_e( 'Top Center', 'zenvy' ); ?></option>
                    <option value="top right"><?php esc_html_e( 'Top Right', 'zenvy' ); ?></option>
                    <option value="center left"><?php esc_html_e( 'Center Left', 'zenvy' ); ?></option>
                    <option value="center"><?php esc_html_e( 'Center', 'zenvy' ); ?></option>
                    <option value="center right"><?php esc_html_e( 'Center Right', 'zenvy' ); ?></option>
                    <option value="bottom left"><?php esc_html_e( 'Bottom Left', 'zenvy' ); ?></option>
                    <option value="bottom center"><?php esc_html_e( 'Bottom Center', 'zenvy' ); ?></option>
                    <option value="bottom right"><?php esc_html_e( 'Bottom Right', 'zenvy' ); ?></option>
                </select>
            </div>
            <# } #>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center background-attachment">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Attachment', 'zenvy' ); ?></span>
                ...
                <select class="select background-attachment-select w-60" data-reset="{{ attachment_reset }}">
                    <option value="scroll"><?php esc_html_e( 'Scroll', 'zenvy' ); ?></option>
                    <option value="fixed"><?php esc_html_e( 'Fixed', 'zenvy' ); ?></option>
                </select>
            </div>
            <# } #>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center background-repeat">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Repeat', 'zenvy' ); ?></span>
                ...
                <select class="select background-repeat-select w-60" data-reset="{{ repeat_reset }}">
                    <option value="no-repeat"><?php esc_html_e( 'No Repeat', 'zenvy' ); ?></option>
                    <option value="repeat"><?php esc_html_e( 'Repeat', 'zenvy' ); ?></option>
                    <option value="repeat-x"><?php esc_html_e( 'Repeat Horizontally', 'zenvy' ); ?></option>
                    <option value="repeat-y"><?php esc_html_e( 'Repeat Vertically', 'zenvy' ); ?></option>
                </select>
            </div>
            <# } #>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center background-size">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Size', 'zenvy' ); ?></span>
                ...
                <select class="select background-size-select w-60" data-reset="{{ size_reset }}">
                    <option value="auto"><?php esc_html_e( 'Auto', 'zenvy' ); ?></option>
                    <option value="cover"><?php esc_html_e( 'Cover', 'zenvy' ); ?></option>
                    <option value="contain"><?php esc_html_e( 'Contain', 'zenvy' ); ?></option>
                </select>
            </div>
            <# } #>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center position-relative background-colors">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Color', 'zenvy' ); ?></span>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center position-relative background-gradient">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Gradient Color', 'zenvy' ); ?></span>
...
$wp_customize->register_control_type( 'Zenvy_Customize_Background_Control' );