...
/**
 * Zenvy_Customize_Typography_Control class
 */
class Zenvy_Customize_Typography_Control extends Zenvy_Customize_Base_Control {
	...
	public function __construct( $manager, $id, $args = [] ) {
		...
		$this->l10n = wp_parse_args(
			$this->l10n,
			[
				'option_default' => esc_html__( 'Default', 'zenvy' ),
			]
		);

		add_action( 'customize_controls_enqueue_scripts', [ $this, 'localize_script' ] );
	}
	...
	public function content_template() {
		...
		<div class="controls-wrap typography-control">
			...
			<div class="control-wrap d-flex justify-content-between align-items-center typography-font_family">
				<span class="customize-control-title w-40"><?php esc_html_e( 'Font Family', 'zenvy' ); ?></span>
			...
			<div class="control-wrap d-flex justify-content-between align-items-center typography-font_variant">
				<span class="customize-control-title w-40"><?php esc_html_e( 'Font Weight', 'zenvy' ); ?></span>
			...
			<div class="control-wrap d-flex justify-content-between align-items-center typography-text_transform">
				<span class="customize-control-title w-40"><?php esc_html_e( 'Text Transform', 'zenvy' ); ?></span>
				...
				<select class="select w-60" data-reset="{{ transform_reset }}">
					<option value=""><?php esc_html_e( 'Default', 'zenvy' ); ?></option>
					<option value="uppercase"><?php esc_html_e( 'Uppercase', 'zenvy' ); ?></option>
					<option value="lowercase"><?php esc_html_e( 'Lowercase', 'zenvy' ); ?></option>
					<option value="capitalize"><?php esc_html_e( 'Capitalize', 'zenvy' ); ?></option>
				</select>
			</div>
			<# } #>
			...
			<div class="control-wrap d-flex justify-content-between align-items-center typography-text_decoration">
				<span class="customize-control-title w-40"><?php esc_html_e( 'Text Decoration', 'zenvy' ); ?></span>
				...
				<select class="select w-60" data-reset="{{ decoration_reset }}">
					<option value=""><?php esc_html_e( 'Default', 'zenvy' ); ?></option>
					<option value="overline"><?php esc_html_e( 'Overline', 'zenvy' ); ?></option>
					<option value="underline"><?php esc_html_e( 'Underline', 'zenvy' ); ?></option>
					<option value="line-through"><?php esc_html_e( 'Line through', 'zenvy' ); ?></option>
				</select>
			</div>
			<# } #>
			...
			<div class="typography-font_size{{ responsive_class }}">
				...
				<div class="d-flex justify-content-between align-items-center">
					<span class="customize-control-title"><?php esc_html_e( 'Font Size', 'zenvy' ); ?></span>
			...
			<div class="typography-line_height{{ responsive_class }}">
				...
				<div class="d-flex justify-content-between align-items-center">
					<span class="customize-control-title"><?php esc_html_e( 'Line Height', 'zenvy' ); ?></span>
			...
			<div class="typography-letter_spacing{{ responsive_class }}">
				...
				<div class="d-flex justify-content-between align-items-center">
					<span class="customize-control-title"><?php esc_html_e( 'Letter Spacing', 'zenvy' ); ?></span>
			...
			<div class="control-wrap d-flex justify-content-between align-items-center position-relative mt-16 typography-colors">
				<span class="customize-control-title"><?php esc_html_e( 'Color', 'zenvy' ); ?></span>
...
$wp_customize->register_control_type( 'Zenvy_Customize_Typography_Control' );
