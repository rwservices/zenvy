...
/**
 * Zenvy_Customize_Multi_Select_Control class
 */
class Zenvy_Customize_Multi_Select_Control extends Zenvy_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'zenvy_multi_select';
...
$wp_customize->register_control_type( 'Zenvy_Customize_Multi_Select_Control' );