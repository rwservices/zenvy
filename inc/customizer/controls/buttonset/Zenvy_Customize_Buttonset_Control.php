...
/**
 * Zenvy_Customize_Buttonset_Control class
 */
class Zenvy_Customize_Buttonset_Control extends Zenvy_Customize_Base_Control {
...
$wp_customize->register_control_type( 'Zenvy_Customize_Buttonset_Control' );