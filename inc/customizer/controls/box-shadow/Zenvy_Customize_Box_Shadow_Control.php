...
/**
 * Zenvy_Customize_Box_Shadow_Control class
 */
class Zenvy_Customize_Box_Shadow_Control extends Zenvy_Customize_Base_Control {
    ...
    public function content_template() { ?>
        ...
        <div class="controls-wrap box-shadow-control">
            ...
            <!-- H Length -->
            <# if ( fields.h_length ) { #>
            <span class="customize-control-title"><?php esc_html_e( 'Horizontal Length', 'zenvy' ); ?></span>
            ...
            <!-- V Length -->
            <# if ( fields.v_length ) { #>
            <span class="customize-control-title"><?php esc_html_e( 'Vertical Length', 'zenvy' ); ?></span>
            ...
            <!-- Blur -->
            <# if ( fields.blur ) { #>
            <span class="customize-control-title"><?php esc_html_e( 'Blur', 'zenvy' ); ?></span>
            ...
            <!-- spread -->
            <# if ( fields.spread ) { #>
            <span class="customize-control-title"><?php esc_html_e( 'Spread', 'zenvy' ); ?></span>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center mb-16 box-shadow-inset active">
                <span class="customize-control-title"><?php esc_html_e( 'Inset', 'zenvy' ); ?></span>
...
$wp_customize->register_control_type( 'Zenvy_Customize_Box_Shadow_Control' );