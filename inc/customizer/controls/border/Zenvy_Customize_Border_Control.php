...
/**
 * Zenvy_Customize_Border_Control class
 */
class Zenvy_Customize_Border_Control extends Zenvy_Customize_Base_Control {
    ...
    public function content_template() { ?>
        ...
        <div class="controls-wrap border-control">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <span class="customize-control-title"><?php esc_html_e( 'Width', 'zenvy' ); ?></span>
            </div>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center position-relative border-style">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Style', 'zenvy' ); ?></span>
                ...
                <select class="select border-style-select w-60" data-reset="{{ style_reset }}">
                    <option value="none"><?php esc_html_e( 'None', 'zenvy' ); ?></option>
                    <option value="solid"><?php esc_html_e( 'Solid', 'zenvy' ); ?></option>
                    <option value="dotted"><?php esc_html_e( 'Dotted', 'zenvy' ); ?></option>
                    <option value="dashed"><?php esc_html_e( 'Dashed', 'zenvy' ); ?></option>
                    <option value="double"><?php esc_html_e( 'Double', 'zenvy' ); ?></option>
                </select>
            </div>
            <# } #>
        ...
        <!-- Radius -->
        <# if ( fields.radius ) { #>
        <span class="customize-control-title"><?php esc_html_e( 'Radius', 'zenvy' ); ?></span>
...
$wp_customize->register_control_type( 'Zenvy_Customize_Border_Control' );