...
class Zenvy_Customizer_Footer_Builder {
    ...
    public function run() {
        ...
        add_filter( 'zenvy_default_theme_options', array( $this, 'footer_defaults' ) );
        add_filter( 'zenvy_builders', array( $this, 'footer_builder' ) );

        add_action( 'zenvy_footer', array( $this, 'zenvy_footer_display' ), 100 );
    }
    ...
    public function footer_builder( $builder ) {
        ...
        $items = apply_filters(
            ...
            array(
                Zenvy_Customizer_Footer_Builder()->footer_copyright   => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_menu => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_social    => array(
                    'name'    => esc_html__( 'Social Icons', 'zenvy' ),
                    'id'      => Zenvy_Customizer_Footer_Builder()->footer_social,
                    'section' => Zenvy_Customizer_Footer_Builder()->footer_social,
                ),
                Zenvy_Customizer_Footer_Builder()->footer_button    => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_html  => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_sidebar_1   => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_sidebar_2   => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_sidebar_3   => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_sidebar_4   => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_sidebar_5   => array(
                ...
                Zenvy_Customizer_Footer_Builder()->footer_sidebar_6   => array(
        ...
        $footer_builder = array(
            Zenvy_Customizer_Footer_Builder()->panel => array(
                'id'         => Zenvy_Customizer_Footer_Builder()->panel,
                'title'      => esc_html__( 'Footer Builder', 'zenvy' ),
                'control_id' => Zenvy_Customizer_Footer_Builder()->builder_section_controller,
                'panel'      => Zenvy_Customizer_Footer_Builder()->panel,
                'section'    => Zenvy_Customizer_Footer_Builder()->builder_section_controller,
                'devices'    => array(
                    'desktop' => esc_html__( 'Global', 'zenvy' )
                ),
                'items'      => $items,
                'rows'       => array(
    ...
    public function customize_register( $wp_customize ) {
        ...
        $wp_customize->add_section(
            ...
            array(
                'title'    => esc_html__( 'Copyright', 'zenvy' ),
                'priority' => 35,
                'panel'    => $this->panel,
            )
        );
        ...
        $wp_customize->add_section(
            $this->footer_menu,
            array(
                'title'    => esc_html__( 'Footer Menu', 'zenvy' ),
                'priority' => 56,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            ...
            array(
                'title'    => esc_html__( 'Footer Sidebar 1', 'zenvy' ),
                'priority' => 56,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            ...
            array(
                'title'    => esc_html__( 'Footer Sidebar 2', 'zenvy' ),
                'priority' => 56,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            ...
            array(
                'title'    => esc_html__( 'Footer Sidebar 3', 'zenvy' ),
                'priority' => 56,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            ...
            array(
                'title'    => esc_html__( 'Footer Sidebar 4', 'zenvy' ),
                'priority' => 56,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            ...
            array(
                'title'    => esc_html__( 'Footer Sidebar 5', 'zenvy' ),
                'priority' => 56,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            ...
            array(
                'title'    => esc_html__( 'Footer Sidebar 6', 'zenvy' ),
                'priority' => 56,
                'panel'    => $this->panel,
            )
        );
        $wp_customize->add_section(
            'zenvy_footer_builder_back_to_top_section',
            array(
                'title'    => esc_html__( 'Scroll to Top', 'zenvy' ),
                'priority' => 65,
                'panel'    => $this->panel,
            )
        );
        ...
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Copyright_Fields.php';
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Social_Icons_Fields.php';
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Button_Fields.php';
        ...
        /* Footer Sidebar */
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Sidebar_1_Fields.php';
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Sidebar_2_Fields.php';
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Sidebar_3_Fields.php';
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Sidebar_4_Fields.php';
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Sidebar_5_Fields.php';
        require ZENVY_THEME_DIR  . 'inc/customizer/builder/footer/options/Zenvy_Customize_Footer_Sidebar_6_Fields.php';
	...
	public function column_elements( $column_elements) {
		foreach ( $column_elements as $element ) {
			...
			if ( file_exists( trailingslashit( get_template_directory() ) . 'template-parts/footer/' . esc_html( $id ). '.php' ) ) {
				...
				echo esc_html__( 'Create New File ', 'zenvy' ) . 'template-parts/footer/' . esc_html( $id ) . '.php';
			}
		}
	}
     ...
     * @return void
     */
    public function zenvy_footer_display() {
...
if ( ! function_exists( 'zenvy_customizer_footer_builder' ) ) {
    ...
    zenvy_customizer_footer_builder()->run();
}
