...
class Zenvy_Customizer_Footer_Builder {
	...
	public function run() {
		...
		add_filter( 'zenvy_default_theme_options', [ $this, 'footer_defaults' ] );
		add_filter( 'zenvy_builders', [ $this, 'footer_builder' ] );

		add_action( 'zenvy_footer', [ $this, 'zenvy_footer_display' ], 100 );
	}
	...
	public function footer_builder( $builder ) {
		...
		$items = apply_filters(
			...
			[
				...
				Zenvy_Customizer_Footer_Builder()->footer_social    => [
				...
				Zenvy_Customizer_Footer_Builder()->footer_button    => [
		...
		$footer_builder = [
			Zenvy_Customizer_Footer_Builder()->panel => [
