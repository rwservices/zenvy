...
<script type="text/html" id="tmpl-zenvy-panel">
	<div class="zenvy-rows">
		...
		<# if ( data.device == 'all' ) { #>
			...
			<div class="zenvy-row-sidebar zenvy-row" data-row-id ="sidebar" data-cols="{{ data.cols.sidebar }}" data-id="{{ data.id }}_sidebar">
				<div class="zenvy-row-inner">
	...
	>
		...
		<div class="grid-stack-item-content">
			...
			<# if ( jQuery.inArray(data.section, widgetsArea) !== -1 ) { #>
				<span class="zenvy-item-design dashicons dashicons-admin-settings" data-tooltip="Design" data-section="{{ data.section }}-settings"></span>
			<# } #>
