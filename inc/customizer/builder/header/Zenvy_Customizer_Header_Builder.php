...
class Zenvy_Customizer_Header_Builder {
	...
	public function run() {
		...
		add_action( 'customize_register', [ $this, 'set_customizer' ], 1 );

		add_action( 'customize_register', [ $this, 'customize_register' ], 3 );

		add_filter( 'zenvy_default_theme_options', [ $this, 'header_defaults' ] );
		add_filter( 'zenvy_builders', [ $this, 'header_builder' ] );

		add_action( 'zenvy_header', [ $this, 'zenvy_header_display' ], 100 );
	}
	...
	public function header_builder( $builder ) {
		...
		$items = apply_filters(
			...
			[
				...
				Zenvy_Customizer_Header_Builder()->primary_menu => [
				...
				Zenvy_Customizer_Header_Builder()->social_icons => [
				...
				Zenvy_Customizer_Header_Builder()->search_icon => [
				...
				Zenvy_Customizer_Header_Builder()->button_one => [
		...
		$header_builder = [
			Zenvy_Customizer_Header_Builder()->panel => [
	...
	public function customize_register( $wp_customize ) {
		...
		require ZENVY_THEME_DIR . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Site_Identity_Fields.php';
		require ZENVY_THEME_DIR . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Primary_Menu_Fields.php';
		require ZENVY_THEME_DIR . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Button_Fields.php';
		require ZENVY_THEME_DIR . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Social_Icons_Fields.php';
		require ZENVY_THEME_DIR . 'inc/customizer/builder/header/options/Zenvy_Customize_Header_Account_Fields.php';
							...
							<div class="container">
								<div class="<?php echo esc_attr( implode( ' ', $top_row_class ) ); ?>">
									...
									if ( array_key_exists( 'col-0', $top_elements ) || array_key_exists( 'col-2', $top_elements ) ) :
										...
										<?php
										if ( $mean_menu_position ) {
											echo ' data-meanMenu="left"'; }
										?>
										>
